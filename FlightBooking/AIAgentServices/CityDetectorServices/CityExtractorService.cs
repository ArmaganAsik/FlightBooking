...
{
    public class CityExtractorService : ICityExtractorService
    {
        private readonly HttpClient _httpClient;
        private readonly OpenAISettings _settings;

        public CityExtractorService(
        ...
        public async Task<string?> ExtractCityAsync(string prompt)
        {
            ...
            var requestBody = new
            {
                ...
                messages = new[]
                {
                    new
                    {
                        role = "system",
                        content =
                            "Sen kullanıcı mesajlarından şehir ve ilçe adlarını çıkaran bir bilgi çıkarım servisinin parçasısın."
                    },
                    new
                    {
                        role = "user",
            ...
            string city = document.RootElement
